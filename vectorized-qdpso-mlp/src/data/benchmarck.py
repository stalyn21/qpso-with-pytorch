...
def load_and_preprocess_data(dataset='iris', split_seed=100):
    dataset_dict = {
        'iris': load_iris,
    ...
    if dataset in dataset_dict:
        ...
        n = 500
        X, y = make_circles(n_samples=n, factor=0.5, noise=0.05, random_state=split_seed)
    ...
    # El split va ANTES del escalado: el scaler se ajusta solo con train+val
    # para no filtrar estadísticas del test set
